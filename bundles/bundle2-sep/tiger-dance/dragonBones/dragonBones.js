    ...
    (function (objects) {
        ...
        var DataParser = /** @class */ (function () {
            ...
            DataParser.parseArmatureData = function (armatureObject, data, frameRate) {
                ...
                for (var skindex in skinObjectList) {
                    var skinObject = skinObjectList[skindex];
                ...
                for (var animindex in animationObjectList) {
                    var animationObject = animationObjectList[animindex];
